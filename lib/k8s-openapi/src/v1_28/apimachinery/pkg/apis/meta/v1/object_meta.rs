...
pub struct ObjectMeta {
    ...
    pub labels: Option<Spanned<std::collections::BTreeMap<String, String>>>,
...
impl crate::DeepMerge for ObjectMeta {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::map::granular(
...
impl<'de> crate::serde::Deserialize<'de> for ObjectMeta {
        ...
        D: crate::serde::Deserializer<'de>,
    {
                        ...
                        E: crate::serde::de::Error,
                    {
                        Ok(match v {
                            ...
                            "deletionGracePeriodSeconds" => {
                                Field::Key_deletion_grace_period_seconds
                            }
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            {
                let mut value_annotations: Option<std::collections::BTreeMap<String, String>> =
                    None;
                let mut value_creation_timestamp: Option<
                    crate::apimachinery::pkg::apis::meta::v1::Time,
                > = None;
                let mut value_deletion_grace_period_seconds: Option<i64> = None;
                let mut value_deletion_timestamp: Option<
                    crate::apimachinery::pkg::apis::meta::v1::Time,
                > = None;
                ...
                let mut value_labels: Option<Spanned<std::collections::BTreeMap<String, String>>> =
                    None;
                let mut value_managed_fields: Option<
                    Vec<crate::apimachinery::pkg::apis::meta::v1::ManagedFieldsEntry>,
                > = None;
                let mut value_name: Option<String> = None;
                let mut value_namespace: Option<String> = None;
                let mut value_owner_references: Option<
                    Vec<crate::apimachinery::pkg::apis::meta::v1::OwnerReference>,
                > = None;
                ...
                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_annotations => {
                            value_annotations = crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_creation_timestamp => {
                            value_creation_timestamp =
                                crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_deletion_grace_period_seconds => {
                            value_deletion_grace_period_seconds =
                                crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_deletion_timestamp => {
                            value_deletion_timestamp =
                                crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_finalizers => {
                            value_finalizers = crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_generate_name => {
                            value_generate_name = crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_generation => {
                            value_generation = crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_labels => {
                            value_labels = crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_managed_fields => {
                            value_managed_fields =
                                crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_name => {
                            value_name = crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_namespace => {
                            value_namespace = crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_owner_references => {
                            value_owner_references =
                                crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_resource_version => {
                            value_resource_version =
                                crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_self_link => {
                            value_self_link = crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Key_uid => {
                            value_uid = crate::serde::de::MapAccess::next_value(&mut map)?
                        }
                        Field::Other => {
                            let _: crate::serde::de::IgnoredAny =
                                crate::serde::de::MapAccess::next_value(&mut map)?;
                        }
                    }
                }
...
impl crate::serde::Serialize for ObjectMeta {
        ...
        S: crate::serde::Serializer,
    {
        ...
        if let Some(value) = &self.creation_timestamp {
            crate::serde::ser::SerializeStruct::serialize_field(
                &mut state,
                "creationTimestamp",
                value,
            )?;
...
impl crate::schemars::JsonSchema for ObjectMeta {
    ...
    fn json_schema(
        __gen: &mut crate::schemars::gen::SchemaGenerator,
    ) -> crate::schemars::schema::Schema {
            ...
            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                properties: [
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations".to_owned()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(crate::schemars::schema::InstanceType::Object))),
                            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
                    ...
                    (
                        ...
                        crate::schemars::schema::Schema::Object(crate::schemars::schema::SchemaObject {
                            metadata: Some(Box::new(crate::schemars::schema::Metadata {
                                description: Some("Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and services. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels".to_owned()),
                                ..Default::default()
                            })),
                            instance_type: Some(crate::schemars::schema::SingleOrVec::Single(Box::new(crate::schemars::schema::InstanceType::Object))),
                            object: Some(Box::new(crate::schemars::schema::ObjectValidation {
