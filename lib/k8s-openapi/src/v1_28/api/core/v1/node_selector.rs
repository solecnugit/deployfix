...
pub struct NodeSelector {
    ...
    pub node_selector_terms: Vec<Spanned<crate::api::core::v1::NodeSelectorTerm>>,
}

impl crate::DeepMerge for NodeSelector {
    fn merge_from(&mut self, other: Self) {
        crate::merge_strategies::list::atomic(
            &mut self.node_selector_terms,
            other.node_selector_terms,
        );
    }
}
...
impl<'de> crate::serde::Deserialize<'de> for NodeSelector {
        ...
        D: crate::serde::Deserializer<'de>,
    {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            {
                let mut value_node_selector_terms: Option<
                    Vec<serde_yaml::Spanned<crate::api::core::v1::NodeSelectorTerm>>,
                > = None;

                while let Some(key) = crate::serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_node_selector_terms => {
                            value_node_selector_terms =
        ...
        deserializer.deserialize_struct("NodeSelector", &["nodeSelectorTerms"], Visitor)
    }
}
...
impl crate::serde::Serialize for NodeSelector {
    ...
    {
        let mut state = serializer.serialize_struct("NodeSelector", 1)?;
